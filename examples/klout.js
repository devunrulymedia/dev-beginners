...
function drawing() {
  var kloutScore = 10;
  // write a thing to draw a face depending on how awesome my klout score is
  // you can draw your own or use sad(), happy(), and ok()
}

// The following functions are available:
//
//  sad ()                   - draw a sad face
//  ok()                     - draw a happy face
//  happy()                  - draw an ok face
